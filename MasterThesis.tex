...
\title{%
  ...
  \small Leveraging deep learning, inductive bias, and music aural skills to learn embedding spaces from raw waveforms with applications to MIR downstream tasks}
