...
%Title parameters
\title{Capturing underlying musical structure: an audio-based approach to the \textit{Ursatz} using stems and deep learning}
...
pdfkeywords={Music Information Retrieval; Music Structure Analysis; 
Deep Learning}
}
