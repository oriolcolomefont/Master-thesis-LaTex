...
\title{%
  ...
  \small Leveraging self-supervised deep neural networks, inductive bias, and aural music skills to learn music embeddings with applications to MIR downstream tasks}
