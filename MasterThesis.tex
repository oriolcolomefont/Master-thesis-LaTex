...
%Title parameters
\title{%
  Exploring inductive bias to assess music structure analysis (MSA) \\
  \large An audio-based approach using musically motivated deep learning to gain insight into the underlying structure of music}
