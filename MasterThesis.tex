...
%Title parameters
%\title{Capturing underlying musical structure: an audio-based approach using deep learning}
\title{%
  Aural skills and the underlying structure of music \\
  \large An audio-based approach to Music Structure Analysis (MSA) using musically motivated deep learning}
...
%Music analysis explanation
\input{music analysis/MSA}
%Methods
