...
\title{%
  ...
  \small Leveraging self-supervised neural networks, inductive bias, and aural skills to learn deep audio embeddings with applications to boundary detection tasks}
