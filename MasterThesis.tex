...
%Title parameters
\title{%
  Uncovering invariant harmonic structures and schemata in music \\
  \small A Deep Learning approach with contrastive learning and inductive bias}
...
\input{music analysis/subsections/MSA}
%Methods
