...
\usepackage{tikz}
\usetikzlibrary{decorations.pathreplacing,fadings,matrix, positioning,shapes,arrows,angles,quotes}
...
\title{%
  ...
  \small Leveraging self-supervised deep neural networks, inductive bias, and aural skills to learn deep audio embeddings with applications to boundary detection tasks}
  
\author{\href{oriol.colome.font@epidemicsound.com}{Oriol Colomé Font}}
\submitdate{July 2023}
\supervisor{Carl Thomé}
\cosupervisor{Carlos Lordelo}
