...
\bottomrule
\end{tabularx}
\caption[SampleCNN layer specifications]{Layer specifications for our SampleCNN model implementation; extended from \cite{CLMR2021}.}
