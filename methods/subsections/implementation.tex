...
Although SSL has been proven effective in speech and audio, its
...
\textbf{Amplitude effects}, like gain, modify the signal's amplitude with a constant factor $g$. We use $g \in [-12, 0]$.
...
\item We finally concatenate the shuffled audio chunks to generate the negative signal:
