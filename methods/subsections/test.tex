...
%Single
\input{figures/cnn/Single Neuron}
%NN
\input{figures/cnn/Network_graph}

%Backpropagation
\input{figures/cnn/Multi-layer_NN}
...
\input{figures/cnn/CNN_diagram}

%Single CNN
\input{figures/cnn/Single_CNN}

%Single pooling layer
\input{figures/cnn/Single_Pooling_Layer}

%Backpropagation
\input{figures/cnn/Back_propagation}

%My model

\input{figures/my model/my model}
