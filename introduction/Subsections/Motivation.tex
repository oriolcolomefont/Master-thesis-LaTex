\section{Motivation}
In the context of this thesis, the research was conducted in collaboration with Epidemic Sound \cite{EpidemicSite}, a renowned organization in the music technology sector. Acquiring an in-depth understanding of music and its fundamental structures serves not only to satisfy intellectual curiosity but also to generate potential advancements and benefits for the technical products and services offered by the company.

As a music enthusiast, professional musician, and scholar, I am fervently dedicated to examining the foundational elements of musical composition, investigating the diverse techniques employed in crafting musical pieces, and discerning the intricate relationships among them.

This passion motivates my pursuit of knowledge on extracting valuable information embedded within music, which can contribute to developing more sophisticated and effective music-related technologies and solutions in the industrial landscape.

By championing exposure as the primary method of learning music, I underscore the importance of immersing oneself in many musical experiences to foster a holistic understanding of music as an art form. Individuals can cultivate well-rounded musical expertise by engaging with various styles, genres, techniques, and learning approaches, ultimately promoting creativity and experimentation in both personal and professional domains. 
