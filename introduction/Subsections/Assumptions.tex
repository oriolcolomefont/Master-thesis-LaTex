...
For example, despite differing cultural contexts, styles, time and key signatures, and sonic properties, we suggest a commonality between Figure \ref{fig:mahler} and Figure \ref{fig:giant_steps}. Both pieces display the same 'musicological flavor', derived from their melodic and harmonic contour envelopes through non-diatonic major thirds.
