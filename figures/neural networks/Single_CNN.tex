\begin{SCfigure}[2\sidecaptionrelwidth][ht]
	...
	\caption[Illustration of a 2D convolutional layer.]{\small{Illustration of a 2D single convolutional layer. If layer $l$ is a convolutional layer, the input data or a feature map of the previous layer is convolved by different kernels to yield the output feature maps of layer $l$.}}
