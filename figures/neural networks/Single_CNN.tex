\begin{SCfigure}[2\sidecaptionrelwidth][ht]
	\centering
        \scalebox{0.8}{
	\begin{tikzpicture}
		\node at (1.5,4){\begin{tabular}{c}input data or \\ feature map\end{tabular}};
	...
	\caption[Illustration of a 2D convolutional layer.]{\small{Illustration of a 2D single convolutional layer. If layer $l$ is a convolutional layer, the input data (if $l = 1$) or a feature map of the previous layer is convolved by different filters (or kernels) to yield the output feature maps of layer $l$.}}
