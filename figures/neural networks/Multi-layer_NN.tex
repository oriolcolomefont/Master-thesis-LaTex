\begin{figure}[ht]
	...
	\begin{tikzpicture}[shorten >=1pt]
		...
		\node[unit](y1) at (12,4){$y_1^{(L+1)}$};
		\node[unit](y2) at (12,2){$y_2^{(L+1)}$};
		\node at (12,1){\vdots};	
		\node[unit](yc) at (12,-0.5){$y_C^{(L+1)}$};
		...
		\draw [decorate,decoration={brace,amplitude=10pt},xshift=-4pt,yshift=0pt] (11.5,5) -- (12.75,5) node [black,midway,yshift=+0.6cm]{output layer};
	\end{tikzpicture}
