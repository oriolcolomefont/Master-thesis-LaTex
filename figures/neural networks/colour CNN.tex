...
\end{tikzpicture}
    \caption[High-level CNN diagram \cite{tikz}.]{\small{CNNs process numerical data, extract features, learn structure, and make predictions through a series of layers.}}
