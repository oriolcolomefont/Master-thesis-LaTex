...
\end{tikzpicture}
    \caption[High-level CNN diagram \cite{tikz}.]{\small{High-level illustration of a CNN. It consists of an input layer that takes in raw data, followed by a downsampling process using convolution and pooling layers to extract features. Finally, fully-connected hidden layers are added for learning the global structure, and an output layer produces the desired predictions.}}
