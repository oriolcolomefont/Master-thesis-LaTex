...
\begin{figure}[ht]
  ...
  \begin{minipage}[b]{1.0\linewidth}
    ...
    \caption[Novelty curve + peaks. Track 391 (SALAMI dataset).]{Novelty curve + peaks. Track 355 (SALAMI dataset) \cite{unsuperMSA}.}
    \label{fig:novelty}
  \end{minipage}
\end{figure}
...
\begin{figure}[ht]
    ...
    \begin{minipage}{0.45\textwidth}
        ...
        \caption[Track 355 (SALAMI dataset) Self-similarity matrix]{Self-similarity matrix computation of the embeddiogram. Track 355 (SALAMI dataset) \cite{unsuperMSA}.}
        \label{fig:SSM}
    \end{minipage}\hfill
    \begin{minipage}{0.45\textwidth}
        \centering
        \includegraphics[width=0.9\textwidth]{figures/images/355lagmatrixgaussiansmoothing.png} % second figure itself
        \caption[Track 355 (SALAMI dataset) SSLM computation of the embeddiogram]{Self-similarity lag matrix. Track 355 (SALAMI dataset) \cite{unsuperMSA}.}
        \label{fig:SSLM}
    \end{minipage}
    \vfill
    \begin{minipage}{0.45\textwidth}
        ...
        \caption[Track 355 (SALAMI dataset). Q-matrix]{Cumulative matrix computation of the embeddiogram. Track 355 (SALAMI dataset) \cite{unsuperMSA}.}
        \label{fig:Q}
    \end{minipage}\hfill
    \begin{minipage}{0.45\textwidth}
        \centering
